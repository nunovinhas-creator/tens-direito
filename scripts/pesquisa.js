...
var paginas = [
  ...
  {url: '/p/habitacao.html',
   ...
   descricao: 'Arrendar (Porta 65) ou comprar (IMT Jovem, Garantia Pública até 100%): os apoios à habitação em vigor em 2026, num só guia.',
   keywords: 'habitação arrendamento renda porta 65 apoio extraordinário imt jovem garantia pública cluster guia',
