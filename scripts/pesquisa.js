...
var paginas = [
  ...
  {url: '/garantia-para-a-infancia.html',
   titulo: 'Garantia para a Infância 2026',
   descricao: 'Complemento automático de até 52,20€/mês ao abono de família, garantindo 127,33€/mês às crianças do 1.º escalão com menos rendimentos. Não é preciso pedir nada.',
   keywords: 'garantia infância abono complemento automático 1.º escalão rendimento referência segurança social',
   cluster: 'familia', clusterNome: 'Família e Crianças', tipo: 'artigo'},
  ...
  {url: '/bolsa-de-estudo-ensino-superior.html',
   ...
   cluster: 'apoios-escolares', clusterNome: 'Apoios Escolares', tipo: 'artigo'},
  {url: '/calendario-escolar-apoios.html',
   titulo: 'Calendário de Apoios Escolares 2026/2027',
   descricao: 'Prazos de julho a outubro num só lugar: Prova Escolar, vales MEGA, bolsa de estudo do ensino superior, início das aulas, ASE e bolsa de mérito.',
   keywords: 'calendário apoios escolares prazos setembro candidatura ase bolsa mérito mega prova escolar',
   cluster: 'apoios-escolares', clusterNome: 'Apoios Escolares', tipo: 'artigo'},
  ...
  {url: '/subsidio-desemprego.html',
   ...
   cluster: 'trabalho-rendimento', clusterNome: 'Trabalho e Rendimento', tipo: 'artigo'},
  {url: '/majoracao-subsidio-desemprego.html',
   titulo: 'Majoração de 10% do subsídio de desemprego 2026',
   descricao: 'Sabe quando tens direito à majoração de 10% do subsídio de desemprego, como pedir (Mod. RP5059-DGSS) e o que significa a notificação automática da Segurança Social.',
   keywords: 'majoração 10% subsídio desemprego cônjuges filhos a cargo rp5059 art 28-a notificação automática segurança social',
   cluster: 'trabalho-rendimento', clusterNome: 'Trabalho e Rendimento', tipo: 'artigo'},
  {url: '/baixa-medica-subsidio-doenca.html',
   ...
   cluster: 'trabalho-rendimento', clusterNome: 'Trabalho e Rendimento', tipo: 'artigo'},
  {url: '/como-pedir-niss.html',
   titulo: 'Como pedir o NISS 2026',
   descricao: 'Pedido online e grátis do NISS para quem não tem Cartão de Cidadão: documentos por perfil, levantamento presencial e o que esperar do prazo.',
   keywords: 'niss número identificação segurança social pedir estrangeiro bilhete identidade vitalício nif utente sns aima',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/declaracao-situacao-contributiva.html',
   titulo: 'Declaração de situação contributiva 2026',
   descricao: 'Como pedir grátis a declaração de situação contributiva (certidão de não dívida): online, na hora, válida 4 meses. Nunca trabalhaste? Só ao balcão.',
   keywords: 'declaração situação contributiva certidão não dívida segurança social direta rc3042 consentimento entidades públicas',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/alterar-morada.html',
   titulo: 'Como alterar a morada no Cartão de Cidadão',
   descricao: 'Um único pedido, grátis, propaga automaticamente para as Finanças e a Segurança Social depois de confirmares por carta. Sem Cartão de Cidadão? Vê o caminho em separado.',
   keywords: 'alterar morada cartão de cidadão finanças segurança social morada fiscal domicílio fiscal mudar de casa',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/renovar-cartao-cidadao.html',
   titulo: 'Renovar o Cartão de Cidadão 2026',
   descricao: 'Automática, online (16,20 €) ou presencial (18 €): preços, prazos e o prazo de 3 de agosto de 2026 para cartões sem MRZ.',
   keywords: 'renovar cartão de cidadão preço prazo online presencial pin automática mrz zona leitura ótica',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/numero-utente-sns.html',
   titulo: 'Número de utente do SNS 2026',
   descricao: 'Automático com o Cartão de Cidadão; presencial e grátis para estrangeiros num centro de saúde. Recém-nascidos e como consultar o número.',
   keywords: 'número utente sns serviço nacional saúde pedir estrangeiro recém-nascido consultar sns24 nascer cidadão',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  ...
  {url: '/certidao-situacao-tributaria.html',
   titulo: 'Certidão de Situação Tributária 2026',
   descricao: 'Como pedir grátis a Certidão de Dívida e Não Dívida no Portal das Finanças: online, na hora, válida 4 meses. Diferente da declaração da Segurança Social.',
   keywords: 'certidão situação tributária dívida não dívida finanças portal das finanças declaração não dívida',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/marcar-atendimento-seguranca-social.html',
   titulo: 'Marcar Atendimento na Segurança Social 2026',
   descricao: 'Como marcar atendimento na Segurança Social: SIGA (web e app), Linha de Marcações (210 548 888), vídeo-atendimento e quando não precisas de marcar.',
   keywords: 'marcar atendimento segurança social siga linha de marcações vídeo atendimento senha presencial niss',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/senha-seguranca-social-direta.html',
   titulo: 'Como pedir (e recuperar) a senha da Segurança Social Direta',
   descricao: 'Registo imediato ("Senha na Hora") por SMS ou email, e recuperação de senha esquecida na Segurança Social Direta — passo a passo verificado.',
   keywords: 'senha segurança social direta registo recuperar esqueci password chave móvel digital niss',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/iban-seguranca-social.html',
   titulo: 'Como alterar o IBAN na Segurança Social',
   descricao: 'Registar ou alterar o IBAN na Segurança Social Direta: comprovativo de titularidade obrigatório, desde a suspensão por fraude — passo a passo.',
   keywords: 'iban segurança social direta conta bancária alterar registar perfil fraude comprovativo titularidade',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  {url: '/chave-movel-digital.html',
   titulo: 'Como ativar a Chave Móvel Digital',
   descricao: 'Três formas de ativar a Chave Móvel Digital, grátis: online com leitor de cartão, por videochamada com biometria, ou num balcão de atendimento.',
   keywords: 'chave móvel digital cmd ativar autenticacao.gov.pt cartão cidadão pin videochamada balcão',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'artigo'},
  ...
  {url: '/amim.html',
   ...
   descricao: 'Guia completo e verificado sobre o AMIM em Portugal: quem pode pedir, junta médica, percentagens e o limiar dos 60%.',
   keywords: 'amim atestado multiuso incapacidade junta médica 60% deficiência psi',
   cluster: 'idosos-incapacidade-cuidadores', clusterNome: 'Idosos, Incapacidade e Cuidadores', tipo: 'artigo'},
  {url: '/amim-beneficios-fiscais.html',
   titulo: 'Benefícios Fiscais do AMIM 2026',
   descricao: 'Benefícios fiscais do AMIM 2026: exclusão parcial de rendimento e deduções acrescidas no IRS, isenção de ISV e IUC, IVA reduzido em produtos de apoio.',
   keywords: 'amim benefícios fiscais irs isv iuc iva dedução isenção veículo deficiência 60%',
   cluster: 'idosos-incapacidade-cuidadores', clusterNome: 'Idosos, Incapacidade e Cuidadores', tipo: 'artigo'},
  {url: '/cartao-europeu-estacionamento.html',
   titulo: 'Cartão Europeu de Estacionamento 2026',
   descricao: 'Cartão europeu de estacionamento 2026: quem tem direito (AMIM ≥60%, ≥95% em deficiência visual), como pedir ao IMT e validade de 10 anos.',
   keywords: 'cartão estacionamento europeu deficiência mobilidade imt lugar reservado amim',
   cluster: 'idosos-incapacidade-cuidadores', clusterNome: 'Idosos, Incapacidade e Cuidadores', tipo: 'artigo'},
  ...
  {url: '/prestacao-social-unica.html',
   ...
   descricao: 'PSU 2026: unifica 13 apoios sociais num regime único não contributivo. Decreto-Lei n.º 166/2026 em vigor — pagamento a partir de 31/12/2026.',
  ...
  {url: '/psu-quando-entra-em-vigor.html',
   titulo: 'PSU 2026: decreto-lei publicado — timeline completa',
   descricao: 'Timeline da PSU: Decreto-Lei n.º 166/2026 publicado e em vigor — pagamento a partir de 31/12/2026.',
   keywords: 'psu quando entra vigor decreto-lei publicado prazo prr ago 2026 dez 2026 timeline',
  ...
  {url: '/psu-trabalho-social.html',
   ...
   cluster: 'prestacao-social-unica', clusterNome: 'Prestação Social Única', tipo: 'artigo'},
  {url: '/como-pedir-psu.html',
   titulo: 'Como pedir a PSU 2026',
   descricao: 'Como e onde pedir a Prestação Social Única: requerimento na Segurança Social Direta, prazos de decisão (30 ou 20 dias) e o que fazer se já recebes um dos 13 apoios.',
   keywords: 'como pedir psu requerimento segurança social direta prazo decisão niss',
   cluster: 'prestacao-social-unica', clusterNome: 'Prestação Social Única', tipo: 'artigo'},
  {url: '/calendario-pagamentos-psu.html',
   titulo: 'Duração e pagamento da PSU 2026',
   descricao: 'Quanto tempo dura a PSU (12 meses renovável) e quando começa a ser paga — produção de efeitos a 31/12/2026 e conversão oficiosa das prestações extintas.',
   keywords: 'psu duração pagamento 12 meses renovável produção de efeitos conversão rsi',
   cluster: 'prestacao-social-unica', clusterNome: 'Prestação Social Única', tipo: 'artigo'},
  {url: '/simulador-psu.html',
   titulo: 'Simulador da PSU 2026',
   descricao: 'Calculadora online da Prestação Social Única com os valores reais do Decreto-Lei n.º 166/2026 — Valor de Referência, adultos equivalentes, CIT, teto e mínimo.',
   keywords: 'simulador psu calculadora prestação social única valor referência adultos equivalentes cit',
   cluster: 'prestacao-social-unica', clusterNome: 'Prestação Social Única', tipo: 'ferramenta'},
  {url: '/p/habitacao.html',
   titulo: 'Apoios à Habitação em Portugal 2026',
   descricao: 'Arrendar (Porta 65), comprar (IMT Jovem, Garantia Pública) ou carência habitacional (1.º Direito): apoios à habitação em vigor em 2026.',
   keywords: 'habitação arrendamento renda porta 65 apoio extraordinário imt jovem garantia pública dedução rendas irs primeiro direito cluster guia',
  ...
  {url: '/deducao-rendas-irs.html',
   titulo: 'Dedução de rendas no IRS 2026: até 900 € por ano',
   descricao: 'O limite de dedução das rendas no IRS sobe para 900 € em 2026 e 1.000 € em 2027 — mas a declaração entregue em 2026 usa ainda 700 €.',
   keywords: 'dedução rendas irs inquilino 900 euros contrato comunicação autoridade tributária rsaa',
   cluster: 'habitacao', clusterNome: 'Habitação', tipo: 'artigo'},
  {url: '/apoio-extraordinario-renda.html',
   ...
   cluster: 'habitacao', clusterNome: 'Habitação', tipo: 'artigo'},
  {url: '/imt-jovem.html',
   titulo: 'IMT Jovem 2026: isenção até 330.539 € na 1.ª casa',
   descricao: 'Isenção total de IMT e Imposto do Selo até 330.539 €, parcial até 660.982 € (8% sobre o excedente). Quem tem direito e como pedir em 2026.',
   keywords: 'imt jovem isenção imposto selo compra casa primeira habitação escritura escalões 330539 660982',
   cluster: 'habitacao', clusterNome: 'Habitação', tipo: 'artigo'},
  {url: '/garantia-publica-credito-habitacao.html',
   titulo: 'Garantia Pública 2026: crédito habitação jovem até 100%',
   descricao: 'O Estado garante até 15% do crédito para jovens até 35 anos, casa até 450.000 €, financiamento até 100%. Só até 31 de dezembro de 2026.',
   keywords: 'garantia pública crédito habitação jovem 100% financiamento sem entrada banco 450000 estado',
   cluster: 'habitacao', clusterNome: 'Habitação', tipo: 'artigo'},
  {url: '/primeiro-direito.html',
   titulo: '1.º Direito 2026: apoio a quem vive em habitação indigna',
   descricao: 'Programa do IHRU para quem vive em condições habitacionais indignas sem meios para as resolver. Candidatura sempre através do município.',
   keywords: 'primeiro direito ihru habitação indigna precariedade insalubridade sobrelotação município elh candidatura',
   cluster: 'habitacao', clusterNome: 'Habitação', tipo: 'artigo'},
  ...
  {url: '/simulador-rsi.html',
   titulo: 'Simulador do RSI 2026',
   descricao: 'Calculadora online do RSI 2026. Simula o valor mensal com base na composição do agregado e nos rendimentos considerados.',
   keywords: 'simulador rsi rendimento social inserção calculadora agregado rendimentos 2026',
   cluster: 'trabalho-rendimento', clusterNome: 'Trabalho e Rendimento', tipo: 'ferramenta'},
  {url: '/simulador-subsidio-desemprego.html',
   titulo: 'Simulador do Subsídio de Desemprego 2026',
   descricao: 'Calculadora online do subsídio de desemprego 2026. Simula o valor mensal e a duração com base na remuneração, idade e tempo de descontos.',
   keywords: 'simulador subsídio desemprego calculadora valor duração dias remuneração referência iefp 2026',
   cluster: 'trabalho-rendimento', clusterNome: 'Trabalho e Rendimento', tipo: 'ferramenta'},
  {url: '/simulador-imt-jovem.html',
   titulo: 'Simulador de IMT Jovem 2026',
   descricao: 'Calcula o IMT e o Imposto do Selo da primeira casa com a isenção jovem, compara com a tabela geral e vê quanto poupas.',
   keywords: 'simulador imt jovem calculadora isenção imposto selo primeira casa comprar escritura poupança 2026',
   cluster: 'habitacao', clusterNome: 'Habitação', tipo: 'ferramenta'},
  {url: '/calendario-pagamentos-seguranca-social.html',
   titulo: 'Calendário de Pagamentos da Segurança Social',
   descricao: 'Datas de pagamento das pensões, abono de família, subsídio de desemprego, RSI, CSI e PSI no mês corrente, segundo o calendário oficial.',
   keywords: 'calendário pagamentos datas quando recebo pensões abono desemprego rsi csi psi vale de correio transferência dia',
   cluster: null, clusterNome: null, tipo: null},
  {url: '/pagamento-apos-deferimento.html',
   titulo: 'Pedido deferido: quando cai o primeiro pagamento',
   descricao: 'O teu pedido foi aprovado mas ainda não recebeste? Quando cai o primeiro pagamento por prestação — desemprego, abono, RSI, pensão, CSI — e se há retroativos à data do pedido.',
   keywords: 'deferido deferimento primeiro pagamento quando recebo aprovado retroativos atraso desemprego abono rsi pensão csi processamento',
   cluster: null, clusterNome: null, tipo: null},
  ...
  {url: '/p/como-pedir.html',
   titulo: 'Como Pedir — Documentos, Senhas e Certidões',
   descricao: 'Guias passo a passo para pedir documentos e acessos: senha da Segurança Social Direta, NISS, Chave Móvel Digital, IBAN e certidões.',
   keywords: 'como pedir documentos senhas certidões acessos niss chave móvel digital iban declaração contributiva',
   cluster: 'como-pedir', clusterNome: 'Como Pedir', tipo: 'pillar'},
  {url: '/noticias.html',
   titulo: 'Notícias',
  ...
  {url: '/dados.html',
   ...
   descricao: 'Historial auditável de observações de fontes oficiais e parâmetros legais dos apoios sociais, publicados como dados abertos: JSON, SQLite e explorador Datasette Lite.',
   keywords: 'dados abertos open data json sqlite datasette parâmetros legais historial fontes oficiais',
   cluster: null, clusterNome: null, tipo: null},
  {url: '/documentos.html',
  ...
  {url: '/documentos/pedido-declaracao-comprovativo-prestacoes.html',
   ...
   cluster: null, clusterNome: null, tipo: null},
  {url: '/p/reformas.html',
   titulo: 'Reformas e Pensões — Guia Completo das Regras',
   descricao: 'Quando te podes reformar, como é calculada a pensão e o que muda se antecipares ou adiares. As regras do regime geral (DL 187/2007), sempre em vigor.',
   keywords: 'reforma pensão idade normal idade pessoal carreira contributiva antecipação bonificação factor sustentabilidade',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'pillar'},
  {url: '/idade-normal.html',
   titulo: 'Idade Normal de Reforma: porque sobe todos os anos',
   descricao: 'A idade normal de reforma sobe todos os anos, indexada à esperança média de vida. A idade do teu ano é fixada por portaria, publicada 2 anos antes.',
   keywords: 'idade normal reforma esperança média de vida portaria idade reforma 2026 2027 2028',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/idade-pessoal.html',
   titulo: 'Idade Pessoal de Reforma: carreira longa reduz a idade',
   descricao: 'Com mais de 40 anos de registo de remunerações, a idade pessoal desce 4 meses por cada ano acima disso — até um mínimo de 60 anos.',
   keywords: 'idade pessoal reforma redução 4 meses carreira longa 40 anos idade mínima 60 anos',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/carreiras-muito-longas.html',
   titulo: 'Carreiras Muito Longas: reforma aos 60 anos sem cortes',
   descricao: 'Com 48 anos de registo de remunerações — ou 46, com início antes dos 17 — podes reformar-te aos 60 anos sem corte por antecipação nem factor de sustentabilidade.',
   keywords: 'carreiras muito longas 48 anos 46 anos reforma sem corte sem penalização',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/outras-antecipacoes.html',
   titulo: 'Outras Antecipações da Reforma: desemprego, deficiência e mais',
   descricao: 'Desemprego de longa duração (57 anos), razões conjunturais (55 anos), profissões desgastantes e deficiência — as outras vias de antecipação da reforma.',
   keywords: 'antecipação reforma desemprego longa duração razões conjunturais profissões desgastantes deficiência',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/como-e-calculada.html',
   titulo: 'Como é Calculada a Pensão: as três peças da fórmula',
   descricao: 'Pensão = Remuneração de Referência × Taxa Global de Formação × Factor de Sustentabilidade. As três peças da fórmula, e quando cada uma entra.',
   keywords: 'como é calculada a pensão fórmula remuneração de referência taxa de formação factor de sustentabilidade',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/que-anos-contam.html',
   titulo: 'Que Anos Contam para a Pensão: densidade e melhores 40 anos',
   descricao: 'Densidade contributiva de 120 dias, anos incompletos, e os melhores 40 anos revalorizados. A fronteira entre os artigos 32.º e 33.º pela data de inscrição.',
   keywords: 'que anos contam pensão densidade contributiva 120 dias melhores 40 anos revalorização inscrição 2002',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/mais-cedo-ou-mais-tarde.html',
  ...
  {url: '/quem-tem-direito-por-parentesco.html',
   ...
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/carreiras-contributivas-estrangeiro.html',
   titulo: 'Carreira Contributiva no Estrangeiro: o que conta para a reforma',
   descricao: 'Trabalhaste na UE, Islândia, Noruega, Liechtenstein ou Suíça? Totalização de períodos (Regulamento 883/2004) e pensão proporcional — cada país paga a sua fração.',
   keywords: 'carreira estrangeiro reforma totalização períodos contributivos pensão proporcional regulamento 883/2004 união europeia eee suíça',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/reforma-reino-unido-brexit.html',
   titulo: 'Reforma e o Reino Unido: Acordo de Saída ou Brexit?',
   descricao: 'A tua reforma no Reino Unido segue regras diferentes consoante a data — Acordo de Saída para quem já lá estava antes de 2020, Protocolo do Acordo de Comércio e Cooperação para situações novas.',
   keywords: 'reino unido brexit reforma pensão acordo de saída acordo comércio cooperação protocolo coordenação segurança social',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/pensao-unificada.html',
   titulo: 'Pensão Unificada: CGA e Segurança Social numa só pensão',
   descricao: 'Descontaste para a Segurança Social e para a Caixa Geral de Aposentações? A pensão unificada junta as duas carreiras (Decreto-Lei n.º 361/98). Condições e como se calcula.',
   keywords: 'pensão unificada CGA segurança social caixa geral aposentações decreto-lei 361/98 totalização',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/caixa-geral-aposentacoes.html',
   titulo: 'Caixa Geral de Aposentações: quem está abrangido e como funciona',
   descricao: 'A CGA fechou a novas inscrições em 1 de janeiro de 2006. Quem já era subscritor mantém-se, com regras próprias — o Estatuto da Aposentação, convergido com a Segurança Social.',
   keywords: 'caixa geral aposentações CGA função pública 2006 fecho subscritores estatuto aposentação convergência',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'}
];
