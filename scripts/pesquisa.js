...
var paginas = [
  ...
  {url: '/garantia-para-a-infancia.html',
   ...
   cluster: 'familia', clusterNome: 'Família e Crianças', tipo: 'artigo'},
  {url: '/creche-gratuita.html',
   titulo: 'Creche gratuita 2026',
   descricao: 'Quem tem direito à creche gratuita, os três canais de acesso (rede solidária, rede pública, bolsa de aderentes) e o que a gratuitidade cobre — nunca a caução.',
   keywords: 'creche gratuita rede solidária acordo bolsa aderentes caução vaga ISS gratuitidade',
   cluster: 'familia', clusterNome: 'Família e Crianças', tipo: 'artigo'},
  ...
  {url: '/carreiras-contributivas-estrangeiro.html',
   titulo: 'Carreira Contributiva no Estrangeiro: totalização de períodos na UE',
   descricao: 'Trabalhaste na UE, Islândia, Noruega, Liechtenstein ou Suíça? Totalização de períodos (Regulamento 883/2004), cálculo pro rata e a dispensa que se aplica à maioria dos casos.',
   keywords: 'carreira estrangeiro reforma totalização períodos contributivos pensão pro rata regulamento 883/2004 união europeia eee suíça 21 20',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/reforma-reino-unido-brexit.html',
   titulo: 'Reforma e o Reino Unido: o Protocolo pós-Brexit',
   descricao: 'Quem já estava sujeito à legislação de um dos lados no fim do período de transição (31/12/2020) mantém-se coberto pelo Protocolo SSC do Acordo de Comércio e Cooperação, sem interrupção.',
   keywords: 'reino unido brexit reforma pensão acordo de saída acordo comércio cooperação protocolo ssc coordenação segurança social período de transição',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
  {url: '/pensao-unificada.html',
   titulo: 'Pensão Unificada: CGA e Segurança Social numa só pensão',
   descricao: 'Descontaste para a Segurança Social e para a Caixa Geral de Aposentações? A pensão unificada tem de ser expressamente requerida (Decreto-Lei n.º 361/98). Condições e como se calcula.',
   keywords: 'pensão unificada CGA segurança social caixa geral aposentações decreto-lei 361/98 totalização soma das parcelas requerimento',
   cluster: 'reformas', clusterNome: 'Reformas e Pensões', tipo: 'artigo'},
