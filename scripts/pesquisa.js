...
var paginas = [
  ...
  {url: '/documentos/reclamacao-decisao-seguranca-social.html',
   ...
   descricao: 'Gera uma minuta de reclamação de uma decisão da Segurança Social (indeferimento, valor errado). Preenche os campos e recebe o texto pronto.',
  ...
  {url: '/documentos/carta-acompanhamento-csi.html',
   ...
   descricao: 'Gera uma carta para acompanhar o Mod. CSI 1 – DGSS quando pedires o Complemento Solidário para Idosos. Não substitui o formulário oficial.',
  ...
  {url: '/documentos/carta-acompanhamento-reavaliacao-abono.html',
   ...
   descricao: 'Gera uma carta para acompanhar o pedido de reavaliação do escalão do abono de família. O canal preferencial é a Segurança Social Direta.',
