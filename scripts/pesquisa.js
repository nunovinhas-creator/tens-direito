...
var paginas = [
  ...
  {url: '/verificador-apoios.html',
   titulo: 'Vê a que apoios podes ser elegível — abono, ASE e bolsas',
   descricao: 'Responde a 4 perguntas e vê a que apoios podes ser elegível — abono de família calculado, mais indicações para ASE, manuais MEGA e Bolsa de Mérito.',
   keywords: 'verificador apoios elegibilidade abono ase mega bolsa mérito perguntas família crianças',
