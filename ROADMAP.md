...
| **31 de dezembro de 2026** | Prazo-limite legal dos contratos de crédito abrangidos pela Garantia Pessoal do Estado (Decreto-Lei n.º 44/2024) — a lei prevê a possibilidade de prorrogação, mas sem confirmação, à data de verificação (2026-09-07), de que a medida vai continuar em 2027 nas mesmas condições. Rever `garantia-publica-credito-habitacao.html`/`fontes.html` se `dre_habitacao_garantia` (watchlist DRE) disparar antes desta data, ou confirmar o desfecho perto dela | `garantia-publica-credito-habitacao.html`, `fontes.html` — ver CLAUDE.md **"CLUSTER HABITAÇÃO"** |
