...
| **Junho** (antes do prazo 31 jul) | Rever ano lectivo/prazo | `prova-escolar.html` — calendário anual, ver CLAUDE.md **"PÁGINAS COM DATAS SAZONAIS"** para a orientação técnica (`verificar_datas.py` não deve disparar antes de junho de 2027) |
...
| **31 de dezembro de 2026** | Prazo-limite legal dos contratos de crédito abrangidos pela Garantia Pessoal do Estado (Decreto-Lei n.º 44/2024, regulamentado pela **Portaria n.º 236-A/2024/1** — é esta que fixa a vigência do protocolo "até 31/12/2026 ou outra data que posteriormente corresponder ao termo de uma eventual prorrogação"). Conta a data da escritura e do contrato de crédito, nunca a do CPCV nem a do início do processo. Sem confirmação, à data de verificação (2026-09-08), de que a medida vai continuar em 2027 nas mesmas condições — uma decisão sobre prorrogação só deve surgir com a proposta de OE 2027, esperada em outubro de 2026, nunca antes. Rever `garantia-publica-credito-habitacao.html`/`fontes.html` se `dre_habitacao_garantia` (watchlist DRE) disparar antes desta data, ou confirmar o desfecho perto dela/depois da proposta de OE2027 | `garantia-publica-credito-habitacao.html`, `fontes.html` — ver CLAUDE.md **"CLUSTER HABITAÇÃO"** |
